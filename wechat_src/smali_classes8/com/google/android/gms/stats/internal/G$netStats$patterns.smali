...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v0, "gms:stats:netstats:pattern:idents"

    const-string/jumbo v1, " *ident=\\[(?<idents>.*)\\](?: uid=(?<uid>-?[0-9]+))?(?: set=(?<set>\\w+))?(?: tag=0x(?<tag>[0-9a-f]+))?.*"
    ...
    const-string/jumbo v0, "gms:stats:netstats:pattern:ident"
    ...
    const-string/jumbo v0, "gms:stats:netstats:pattern:history"

    const-string/jumbo v1, ".*bucketDuration=(?<duration>[0-9]+).*"
    ...
    const-string/jumbo v0, "gms:stats:netstats:pattern:bucket"
    ...
    const-string/jumbo v0, "gms:stats:netstats:pattern:uid_start"

    const-string/jumbo v1, "UID stats:|Detailed UID stats:"
    ...
    const-string/jumbo v0, "gms:stats:netstats:pattern:uid_tag_start"

    const-string/jumbo v1, "UID tag stats:"
    ...
    const-string/jumbo v0, "gms:stats:netstats:pattern:type_both"
    ...
    const-string/jumbo v0, "gms:stats:netstats:pattern:type_background"
    ...
    const-string/jumbo v0, "gms:stats:netstats:pattern:type_foreground"
    ...
    const-string/jumbo v0, "gms:stats:netstats:pattern:type_debug_vpn_in_pattern"

    const-string/jumbo v1, "DBG_VPN_IN"
    ...
    const-string/jumbo v0, "gms:stats:netstats:pattern:type_debug_vpn_out_pattern"

    const-string/jumbo v1, "DBG_VPN_OUT"
    ...
    const-string/jumbo v0, "gms:stats:netstats:pattern:tag_radix"
    ...
    const-string/jumbo v0, "gms:stats:netstats:pattern:ts_to_millis"
