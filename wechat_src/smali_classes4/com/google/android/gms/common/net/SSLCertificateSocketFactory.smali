...
.method public static verifyHostname(Ljava/net/Socket;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "Attempt to verify non-SSL socket"
    ...
    const-string/jumbo v1, "Cannot verify SSL socket without session"
...
.method private static zza(Ljava/net/Socket;I)V
    ...
    const-string/jumbo v1, "setHandshakeTimeout"
    ...
    const-string/jumbo v3, "Failed to invoke setSocketHandshakeTimeout on "
    ...
    const-string/jumbo v3, " does not implement setSocketHandshakeTimeout"
...
.method private static zza(Ljava/net/Socket;Ljava/security/PrivateKey;)V
    ...
    const-string/jumbo v1, "setChannelIdPrivateKey"
    ...
    const-string/jumbo v3, "Failed to invoke setChannelIdPrivateKey on "
    ...
    const-string/jumbo v3, " does not implement setChannelIdPrivateKey"
...
.method private static zza(Ljava/net/Socket;[B)V
    ...
    const-string/jumbo v3, "Failed to invoke setNpnProtocols on "
    ...
    const-string/jumbo v3, " does not implement setNpnProtocols"
...
.method private static zzb(Ljava/net/Socket;[B)V
    ...
    const-string/jumbo v3, "Failed to invoke setAlpnProtocols on "
    ...
    const-string/jumbo v3, " does not implement setAlpnProtocols"
...
.method public getAlpnSelectedProtocol(Ljava/net/Socket;)[B
    ...
    const-string/jumbo v1, "getAlpnSelectedProtocol"
    ...
    const-string/jumbo v3, "Failed to invoke getAlpnSelectedProtocol on "
    ...
    const-string/jumbo v3, " does not implement getAlpnSelectedProtocol"
...
.method public getNpnSelectedProtocol(Ljava/net/Socket;)[B
    ...
    const-string/jumbo v3, "Failed to invoke getNpnSelectedProtocol on "
    ...
    const-string/jumbo v3, " does not implement getNpnSelectedProtocol"
...
.method public setHostname(Ljava/net/Socket;Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "Failed to invoke setHostname on "
    ...
    const-string/jumbo v3, " does not implement setHostname"
...
.method public setSoWriteTimeout(Ljava/net/Socket;I)V
    ...
    const-string/jumbo v1, "setSoWriteTimeout"
    ...
    const-string/jumbo v3, "Failed to invoke setSoWriteTimeout on "
    ...
    const-string/jumbo v3, " does not implement setSoWriteTimeout"
...
.method public setUseSessionTickets(Ljava/net/Socket;Z)V
    ...
    const-string/jumbo v3, "Failed to invoke setUseSessionTickets on "
    ...
    const-string/jumbo v3, " does not implement setUseSessionTickets"
