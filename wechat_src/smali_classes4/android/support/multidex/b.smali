...
# static fields
.field private static zD:Ljava/lang/reflect/Method;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/multidex/b;->zD:Ljava/lang/reflect/Method;
    :try_end_0
...
.method static a(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Ljava/io/File;Z)Ljava/util/List;
    ...
    .line 1153
    invoke-static {v1}, Landroid/support/multidex/c;->m(Ljava/io/File;)J
    ...
    .line 2137
    invoke-static {p0}, Landroid/support/multidex/b;->N(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static {v1}, Landroid/support/multidex/b;->k(Ljava/io/File;)J
    ...
    .line 102
    :cond_3
    invoke-static {v1, p2}, Landroid/support/multidex/b;->d(Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    .line 2366
    sget-object v1, Landroid/support/multidex/b;->zD:Ljava/lang/reflect/Method;
...
.method private static a(Landroid/content/Context;Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    .line 123
    invoke-static {v5}, Landroid/support/multidex/b;->l(Ljava/io/File;)Z
...
.method private static d(Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    .line 170
    invoke-static {p1, v6}, Landroid/support/multidex/b;->f(Ljava/io/File;Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "classes2.dex"
    ...
    .line 196
    invoke-static {v9}, Landroid/support/multidex/b;->l(Ljava/io/File;)Z
...
.method static l(Ljava/io/File;)Z
    .locals 2
