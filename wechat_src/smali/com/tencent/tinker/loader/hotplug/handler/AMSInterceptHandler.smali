...
.method private processActivityIntent(Landroid/content/Intent;)V
    ...
    .line 154
    invoke-direct {p0, v1}, Lcom/tencent/tinker/loader/hotplug/handler/AMSInterceptHandler;->hasTransparentTheme(Landroid/content/pm/ActivityInfo;)Z
    ...
    invoke-static {v0, v1, v3}, Lcom/tencent/tinker/loader/hotplug/ActivityStubManager;->assignStub(Ljava/lang/String;IZ)Ljava/lang/String;

    move-result-object v1

    .line 156
    invoke-direct {p0, p1, v2, v0, v1}, Lcom/tencent/tinker/loader/hotplug/handler/AMSInterceptHandler;->storeAndReplaceOriginalComponentName(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
