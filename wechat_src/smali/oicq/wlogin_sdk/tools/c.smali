...
.method private static a([J[B)V
    ...
    invoke-static {v1}, Loicq/wlogin_sdk/tools/c;->b2iu(B)J
...
.method public static boE(Ljava/lang/String;)[B
    .locals 3
...
.method private md5Transform([B)V
    ...
    invoke-static {v0, v1}, Loicq/wlogin_sdk/tools/c;->a([J[B)V
...
.method private md5Update([BI)V
    ...
    invoke-static {v4, p1, v2, v1, v0}, Loicq/wlogin_sdk/tools/c;->md5Memcpy([B[BIII)V

    .line 269
    iget-object v2, p0, Loicq/wlogin_sdk/tools/c;->buffer:[B

    invoke-direct {p0, v2}, Loicq/wlogin_sdk/tools/c;->md5Transform([B)V
    ...
    invoke-static {v1, p1, v2, v0, v3}, Loicq/wlogin_sdk/tools/c;->md5Memcpy([B[BIII)V
...
.method private md5Update(Ljava/io/InputStream;J)Z
    ...
    :try_start_0
    invoke-virtual {p1, v5, v6, v0}, Ljava/io/InputStream;->read([BII)I
    :try_end_0
    ...
    invoke-static {v6, v5, v2, v1, v0}, Loicq/wlogin_sdk/tools/c;->md5Memcpy([B[BIII)V
