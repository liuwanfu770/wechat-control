...
.method private internalMeasureChildren(II)V
    ...
    iget-wide v4, v3, Landroid/support/constraint/solver/Metrics;->measures:J

    const-wide/16 v18, 0x1

    add-long v4, v4, v18

    iput-wide v4, v3, Landroid/support/constraint/solver/Metrics;->measures:J
    ...
    invoke-virtual {v0, v9}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWidth(I)V
    ...
    invoke-virtual {v0, v9}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWrapWidth(I)V
...
.method private internalMeasureDimensions(II)V
    ...
    .line 1400
    invoke-virtual/range {v20 .. v20}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->getResolutionWidth()Landroid/support/constraint/solver/widgets/ResolutionDimension;
    ...
    .line 1403
    invoke-virtual/range {v20 .. v20}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->getResolutionHeight()Landroid/support/constraint/solver/widgets/ResolutionDimension;
    ...
    invoke-virtual/range {v20 .. v20}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->isSpreadWidth()Z
    ...
    invoke-virtual {v3, v6}, Landroid/support/constraint/solver/widgets/ResolutionDimension;->resolve(I)V
    ...
    invoke-virtual/range {v20 .. v20}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->isSpreadHeight()Z
    ...
    invoke-virtual/range {v22 .. v22}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->isResolved()Z
    ...
    .line 1429
    invoke-virtual/range {v22 .. v22}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->getResolvedValue()F
    ...
    invoke-virtual {v0, v4}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHeight(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWrapHeight(I)V
...
.method private setChildrenConstraints()V
    ...
    invoke-virtual {v0, v4, v1, v5}, Landroid/support/constraint/ConstraintLayout;->setDesignInformation(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/constraint/ConstraintLayout;->getViewWidget(Landroid/view/View;)Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    iget v1, v0, Landroid/support/constraint/ConstraintLayout;->mConstraintSetId:I
    ...
    invoke-virtual {v1}, Landroid/support/constraint/Constraints;->getConstraintSet()Landroid/support/constraint/ConstraintSet;
    ...
    invoke-virtual {v1, v0}, Landroid/support/constraint/ConstraintHelper;->updatePreLayout(Landroid/support/constraint/ConstraintLayout;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/constraint/Placeholder;->updatePreLayout(Landroid/support/constraint/ConstraintLayout;)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/constraint/ConstraintLayout;->getViewWidget(Landroid/view/View;)Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .line 877
    invoke-virtual {v9}, Landroid/support/constraint/ConstraintLayout$LayoutParams;->validate()V

    .line 878
    iget-boolean v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->helped:Z
    ...
    iput-boolean v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->helped:Z
    ...
    .line 899
    :cond_b
    invoke-virtual {v1, v3}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setCompanionWidget(Ljava/lang/Object;)V
    ...
    invoke-virtual {v2, v1}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->add(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V

    .line 902
    iget-boolean v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->verticalDimensionFixed:Z

    if-eqz v2, :cond_c

    iget-boolean v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->horizontalDimensionFixed:Z
    ...
    .line 909
    iget v3, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->resolvedGuideEnd:I

    .line 910
    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->resolvedGuidePercent:F
    ...
    .line 913
    iget v3, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->guideEnd:I

    .line 914
    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->guidePercent:F
    ...
    .line 917
    invoke-virtual {v1, v2}, Landroid/support/constraint/solver/widgets/Guideline;->setGuidePercent(F)V
    ...
    invoke-virtual {v0, v4, v2, v5}, Landroid/support/constraint/ConstraintLayout;->setDesignInformation(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v2}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setDebugName(Ljava/lang/String;)V
    :try_end_1
    ...
    .line 919
    invoke-virtual {v1, v4}, Landroid/support/constraint/solver/widgets/Guideline;->setGuideBegin(I)V
    ...
    .line 921
    invoke-virtual {v1, v3}, Landroid/support/constraint/solver/widgets/Guideline;->setGuideEnd(I)V
    ...
    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->leftToRight:I

    const/4 v3, -0x1

    if-ne v2, v3, :cond_14

    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->rightToLeft:I

    const/4 v3, -0x1

    if-ne v2, v3, :cond_14

    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->rightToRight:I
    ...
    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->startToEnd:I

    const/4 v3, -0x1

    if-ne v2, v3, :cond_14

    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->endToStart:I

    const/4 v3, -0x1

    if-ne v2, v3, :cond_14

    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->endToEnd:I
    ...
    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->editorAbsoluteX:I

    const/4 v3, -0x1

    if-ne v2, v3, :cond_14

    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->editorAbsoluteY:I
    ...
    .line 943
    :cond_14
    iget v12, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->resolvedLeftToLeft:I

    .line 944
    iget v13, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->resolvedLeftToRight:I

    .line 945
    iget v5, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->resolvedRightToLeft:I

    .line 946
    iget v4, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->resolvedRightToRight:I

    .line 947
    iget v6, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->resolveGoneLeftMargin:I

    .line 948
    iget v3, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->resolveGoneRightMargin:I

    .line 949
    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->resolvedHorizontalBias:F
    ...
    .line 954
    iget v12, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->leftToLeft:I

    .line 955
    iget v13, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->leftToRight:I

    .line 956
    iget v5, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->rightToLeft:I

    .line 957
    iget v4, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->rightToRight:I

    .line 958
    iget v6, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->goneLeftMargin:I

    .line 959
    iget v3, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->goneRightMargin:I

    .line 960
    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->horizontalBias:F
    ...
    .line 963
    iget v7, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->startToStart:I
    ...
    .line 964
    iget v12, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->startToStart:I
    ...
    .line 970
    iget v7, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->endToStart:I
    ...
    invoke-virtual {v1, v2, v3, v4}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->connectCircularConstraint(Landroid/support/constraint/solver/widgets/ConstraintWidget;FI)V
    ...
    invoke-virtual {v1, v2, v3}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setOrigin(II)V
    ...
    .line 1113
    :goto_d
    iget-object v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->dimensionRatio:Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setDimensionRatio(Ljava/lang/String;)V

    .line 1116
    :cond_19
    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->horizontalWeight:F

    invoke-virtual {v1, v2}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHorizontalWeight(F)V

    .line 1117
    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->verticalWeight:F

    invoke-virtual {v1, v2}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setVerticalWeight(F)V

    .line 1118
    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->horizontalChainStyle:I

    invoke-virtual {v1, v2}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHorizontalChainStyle(I)V

    .line 1119
    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->verticalChainStyle:I

    invoke-virtual {v1, v2}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setVerticalChainStyle(I)V

    .line 1120
    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->matchConstraintDefaultWidth:I
    ...
    invoke-virtual {v1, v2, v3, v4, v5}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHorizontalMatchStyle(IIIF)V

    .line 1123
    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->matchConstraintDefaultHeight:I
    ...
    invoke-virtual {v1, v2, v3, v4, v5}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setVerticalMatchStyle(IIIF)V

    goto/16 :goto_8

    .line 965
    :cond_1a
    iget v7, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->startToEnd:I
    ...
    .line 966
    iget v13, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->startToEnd:I

    goto/16 :goto_9

    .line 972
    :cond_1b
    iget v7, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->endToEnd:I
    ...
    .line 973
    iget v4, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->endToEnd:I
    ...
    invoke-direct {v0, v12}, Landroid/support/constraint/ConstraintLayout;->getTargetWidget(I)Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    iget v6, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->goneTopMargin:I
    ...
    iget v6, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->goneBottomMargin:I
    ...
    iput-boolean v4, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->needsBaseline:Z

    .line 1060
    const/4 v4, 0x1

    iput-boolean v4, v2, Landroid/support/constraint/ConstraintLayout$LayoutParams;->needsBaseline:Z
    ...
    .line 1073
    invoke-virtual {v1, v10}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHorizontalBiasPercent(F)V

    .line 1075
    :cond_22
    iget v2, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->verticalBias:F
...
.method protected onLayout(ZIIII)V
    ...
    .line 1880
    iget-object v6, v1, Landroid/support/constraint/ConstraintLayout$LayoutParams;->widget:Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    iget-boolean v7, v1, Landroid/support/constraint/ConstraintLayout$LayoutParams;->isGuideline:Z

    if-nez v7, :cond_0

    iget-boolean v7, v1, Landroid/support/constraint/ConstraintLayout$LayoutParams;->isHelper:Z
    ...
    .line 1887
    :cond_0
    iget-boolean v1, v1, Landroid/support/constraint/ConstraintLayout$LayoutParams;->isInPlaceholder:Z
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v3, v15, v0}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->optimizeForDimensions(II)V
    ...
    .line 1621
    const-string/jumbo v2, "First pass"
    ...
    invoke-virtual {v2, v15}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->setWidth(I)V
    ...
    .line 1739
    const-string/jumbo v2, "3rd pass"
