...
.method private enforceBFS(Landroid/support/constraint/solver/LinearSystem$Row;)I
    ...
    iget-wide v4, v2, Landroid/support/constraint/solver/Metrics;->bfs:J

    const-wide/16 v6, 0x1

    add-long/2addr v4, v6

    iput-wide v4, v2, Landroid/support/constraint/solver/Metrics;->bfs:J
    ...
    .line 750
    iget-object v7, v15, Landroid/support/constraint/solver/ArrayRow;->variable:Landroid/support/constraint/solver/SolverVariable;
    ...
    .line 756
    iget-boolean v7, v15, Landroid/support/constraint/solver/ArrayRow;->isSimpleDefinition:Z

    if-nez v7, :cond_6

    .line 759
    iget v7, v15, Landroid/support/constraint/solver/ArrayRow;->constantValue:F
    ...
    .line 766
    iget-object v3, v15, Landroid/support/constraint/solver/ArrayRow;->variables:Landroid/support/constraint/solver/ArrayLinkedVariables;
    ...
    iget-object v4, v0, Landroid/support/constraint/solver/SolverVariable;->strengthVector:[F
    ...
    .line 793
    iget-object v5, v2, Landroid/support/constraint/solver/ArrayRow;->variable:Landroid/support/constraint/solver/SolverVariable;
    ...
    iget-wide v6, v5, Landroid/support/constraint/solver/Metrics;->pivots:J

    const-wide/16 v8, 0x1

    add-long/2addr v6, v8

    iput-wide v6, v5, Landroid/support/constraint/solver/Metrics;->pivots:J
    ...
    invoke-virtual {v3, v2}, Landroid/support/constraint/solver/SolverVariable;->updateReferencesWithNewDefinition(Landroid/support/constraint/solver/ArrayRow;)V
...
.method private increaseTableSize()V
    ...
    iget-wide v2, v0, Landroid/support/constraint/solver/Metrics;->maxTableSize:J
...
.method displaySystemInformations()V
    ...
    const-string/jumbo v4, ", actual size: "
    ...
    const-string/jumbo v3, " 0 occupied cells, "
...
.method public getMemoryUsed()I
    ...
    invoke-virtual {v1}, Landroid/support/constraint/solver/ArrayRow;->sizeInBytes()I
...
.method minimizeGoal(Landroid/support/constraint/solver/LinearSystem$Row;)V
    ...
    iget-wide v2, v0, Landroid/support/constraint/solver/Metrics;->maxVariables:J
    ...
    iget-wide v2, v0, Landroid/support/constraint/solver/Metrics;->maxRows:J
