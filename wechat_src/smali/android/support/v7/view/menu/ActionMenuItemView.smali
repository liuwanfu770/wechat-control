...
.field aeM:Landroid/support/v7/view/menu/j;

.field aeN:Landroid/support/v7/view/menu/h$b;

.field private aeO:Landroid/support/v7/widget/ab;

.field aeP:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 74
    invoke-direct {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->hI()Z

    move-result v1

    iput-boolean v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeQ:Z

    .line 75
    sget-object v1, Landroid/support/v7/a/a$a;->ActionMenuItemView:[I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeT:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeS:I
...
.method private hJ()V
    ...
    .line 188
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Hg:Ljava/lang/CharSequence;
    ...
    .line 189
    :goto_0
    iget-object v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Xn:Landroid/graphics/drawable/Drawable;

    if-eqz v4, :cond_0

    iget-object v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeM:Landroid/support/v7/view/menu/j;

    .line 190
    invoke-virtual {v4}, Landroid/support/v7/view/menu/j;->iq()Z

    move-result v4

    if-eqz v4, :cond_1

    iget-boolean v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeQ:Z

    if-nez v4, :cond_0

    iget-boolean v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeR:Z
    ...
    .line 195
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeM:Landroid/support/v7/view/menu/j;
...
.method public final a(Landroid/support/v7/view/menu/j;)V
    ...
    .prologue
    .line 124
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeM:Landroid/support/v7/view/menu/j;
    ...
    .line 133
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeO:Landroid/support/v7/widget/ab;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeO:Landroid/support/v7/widget/ab;
...
.method public onClick(Landroid/view/View;)V
    ...
    .prologue
    .line 150
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeN:Landroid/support/v7/view/menu/h$b;
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeM:Landroid/support/v7/view/menu/j;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeQ:Z

    .line 95
    invoke-direct {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->hJ()V
...
.method public onMeasure(II)V
    ...
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeS:I
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Xn:Landroid/graphics/drawable/Drawable;
    ...
    .line 293
    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Xn:Landroid/graphics/drawable/Drawable;
...
.method public setExpandedFormat(Z)V
    ...
    .prologue
    .line 179
    iget-boolean v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeR:Z

    if-eq v0, p1, :cond_0

    .line 180
    iput-boolean p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeR:Z
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 215
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Xn:Landroid/graphics/drawable/Drawable;
    ...
    .line 219
    iget v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeT:I
    ...
    .line 221
    iget v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeT:I
    ...
    .line 226
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeT:I
...
.method public setItemInvoker(Landroid/support/v7/view/menu/h$b;)V
    ...
    .prologue
    .line 156
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeN:Landroid/support/v7/view/menu/h$b;
...
.method public setPadding(IIII)V
    ...
    .prologue
    .line 113
    iput p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeS:I
...
.method public setPopupCallback(Landroid/support/v7/view/menu/ActionMenuItemView$b;)V
    ...
    .prologue
    .line 160
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->aeP:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 247
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Hg:Ljava/lang/CharSequence;
