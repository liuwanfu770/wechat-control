...
# static fields
.field private static IX:Landroid/support/v4/content/d;

.field private static final mLock:Ljava/lang/Object;


# instance fields
.field final IU:Ljava/util/HashMap;
...
.field final IW:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/content/d;->IU:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Landroid/support/v4/content/d;->IV:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Landroid/support/v4/content/d;->IW:Ljava/util/ArrayList;

    .line 114
    iput-object p1, p0, Landroid/support/v4/content/d;->mAppContext:Landroid/content/Context;
...
.method public static V(Landroid/content/Context;)Landroid/support/v4/content/d;
    .locals 3
    ...
    .line 106
    :try_start_0
    sget-object v0, Landroid/support/v4/content/d;->IX:Landroid/support/v4/content/d;
    ...
    sput-object v0, Landroid/support/v4/content/d;->IX:Landroid/support/v4/content/d;
...
.method public final a(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
    ...
    .prologue
    .line 140
    iget-object v2, p0, Landroid/support/v4/content/d;->IU:Ljava/util/HashMap;
    ...
    .line 142
    iget-object v0, p0, Landroid/support/v4/content/d;->IU:Ljava/util/HashMap;
    ...
    .line 145
    iget-object v1, p0, Landroid/support/v4/content/d;->IU:Ljava/util/HashMap;
    ...
    .line 150
    iget-object v0, p0, Landroid/support/v4/content/d;->IV:Ljava/util/HashMap;
    ...
    .line 153
    iget-object v5, p0, Landroid/support/v4/content/d;->IV:Ljava/util/HashMap;
...
.method public final b(Landroid/content/Intent;)Z
    ...
    .prologue
    .line 213
    iget-object v13, p0, Landroid/support/v4/content/d;->IU:Ljava/util/HashMap;
    ...
    .line 215
    iget-object v1, p0, Landroid/support/v4/content/d;->mAppContext:Landroid/content/Context;
    ...
    .line 227
    :cond_0
    iget-object v1, p0, Landroid/support/v4/content/d;->IV:Ljava/util/HashMap;
    ...
    .line 236
    :cond_2
    iget-boolean v1, v9, Landroid/support/v4/content/d$b;->Ja:Z
    ...
    iput-boolean v7, v9, Landroid/support/v4/content/d$b;->Ja:Z
    ...
    iput-boolean v3, v1, Landroid/support/v4/content/d$b;->Ja:Z
    ...
    .line 272
    :cond_7
    iget-object v1, p0, Landroid/support/v4/content/d;->IW:Ljava/util/ArrayList;
...
.method public final unregisterReceiver(Landroid/content/BroadcastReceiver;)V
    ...
    .prologue
    .line 170
    iget-object v7, p0, Landroid/support/v4/content/d;->IU:Ljava/util/HashMap;
    ...
    iput-boolean v2, v1, Landroid/support/v4/content/d$b;->Jb:Z
    ...
    .line 180
    iget-object v2, p0, Landroid/support/v4/content/d;->IV:Ljava/util/HashMap;
    ...
    .line 184
    iget-object v9, v3, Landroid/support/v4/content/d$b;->receiver:Landroid/content/BroadcastReceiver;
    ...
    iput-boolean v9, v3, Landroid/support/v4/content/d$b;->Jb:Z
