...
.method constructor <init>(Landroid/arch/lifecycle/ComputableLiveData;)V
    ...
    .prologue
    .line 86
    iput-object p1, p0, Landroid/arch/lifecycle/ComputableLiveData$2;->cn:Landroid/arch/lifecycle/ComputableLiveData;
...
.method public run()V
    ...
    .line 94
    :cond_0
    iget-object v0, p0, Landroid/arch/lifecycle/ComputableLiveData$2;->cn:Landroid/arch/lifecycle/ComputableLiveData;
    ...
    :goto_0
    :try_start_0
    iget-object v4, p0, Landroid/arch/lifecycle/ComputableLiveData$2;->cn:Landroid/arch/lifecycle/ComputableLiveData;
    ...
    invoke-static {v4}, Landroid/arch/lifecycle/ComputableLiveData;->d(Landroid/arch/lifecycle/ComputableLiveData;)Landroid/arch/lifecycle/LiveData;
    ...
    .line 107
    :cond_2
    iget-object v2, p0, Landroid/arch/lifecycle/ComputableLiveData$2;->cn:Landroid/arch/lifecycle/ComputableLiveData;

    invoke-static {v2}, Landroid/arch/lifecycle/ComputableLiveData;->b(Landroid/arch/lifecycle/ComputableLiveData;)Ljava/util/concurrent/atomic/AtomicBoolean;
