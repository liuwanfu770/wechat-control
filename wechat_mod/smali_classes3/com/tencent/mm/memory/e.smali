...
# instance fields
.field protected hER:Ljava/util/NavigableMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private hES:Ljava/util/Vector;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Vector",
            "<",
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/tencent/mm/memory/e;->hER:Ljava/util/NavigableMap;
    ...
    iput-object v0, p0, Lcom/tencent/mm/memory/e;->hES:Ljava/util/Vector;

    .line 23
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/tencent/mm/memory/e;->hET:J
...
.method static synthetic a(Lcom/tencent/mm/memory/e;)V
    ...
    .line 1045
    :goto_0
    iget-object v0, p0, Lcom/tencent/mm/memory/e;->hES:Ljava/util/Vector;
    ...
    .line 1048
    invoke-virtual {v0}, Lcom/tencent/mm/memory/e$a;->aCw()Ljava/lang/Comparable;
    ...
    .line 1052
    invoke-virtual {v0}, Lcom/tencent/mm/memory/e$a;->aCx()J

    move-result-wide v8

    .line 1053
    invoke-virtual {v0}, Lcom/tencent/mm/memory/e$a;->aCy()I
    ...
    .line 1057
    :goto_1
    iget-wide v10, p0, Lcom/tencent/mm/memory/e;->hET:J

    invoke-virtual {p0}, Lcom/tencent/mm/memory/e;->aCs()J
    ...
    .line 1060
    invoke-virtual {p0, v10}, Lcom/tencent/mm/memory/e;->bA(Ljava/lang/Object;)J
    ...
    invoke-direct {p0, v10, v11}, Lcom/tencent/mm/memory/e;->vT(J)V
    ...
    .line 1066
    iget-object v1, p0, Lcom/tencent/mm/memory/e;->hER:Ljava/util/NavigableMap;
...
.method private declared-synchronized vT(J)V
    ...
    :try_start_0
    iget-wide v0, p0, Lcom/tencent/mm/memory/e;->hET:J
...
.method public declared-synchronized a(Ljava/lang/Comparable;)Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/tencent/mm/memory/e;->hER:Ljava/util/NavigableMap;
    ...
    .line 74
    iget-object v2, p0, Lcom/tencent/mm/memory/e;->hER:Ljava/util/NavigableMap;

    invoke-virtual {v0}, Lcom/tencent/mm/memory/d;->aCv()Ljava/lang/Object;
    ...
    .line 75
    invoke-virtual {p0, v1}, Lcom/tencent/mm/memory/e;->bA(Ljava/lang/Object;)J

    move-result-wide v2

    invoke-virtual {p0, v2, v3}, Lcom/tencent/mm/memory/e;->vU(J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final a(Lcom/tencent/mm/memory/e$a;)V
    ...
    .line 29
    invoke-virtual {p0}, Lcom/tencent/mm/memory/e;->MF()V

    .line 30
    return-void
.end method

.method protected abstract aCs()J
.end method

.method protected abstract aCt()J
.end method
...
.method protected abstract bA(Ljava/lang/Object;)J
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)J"
        }
...
.method protected abstract bB(Ljava/lang/Object;)Ljava/lang/Comparable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)TS;"
        }
...
.method public declared-synchronized bz(Ljava/lang/Object;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)V"
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/tencent/mm/memory/e;->bB(Ljava/lang/Object;)Ljava/lang/Comparable;

    move-result-object v1

    .line 113
    invoke-virtual {p0, p1}, Lcom/tencent/mm/memory/e;->bA(Ljava/lang/Object;)J

    move-result-wide v2

    .line 114
    invoke-virtual {p0}, Lcom/tencent/mm/memory/e;->aCt()J
    ...
    :cond_1
    :try_start_1
    iget-wide v4, p0, Lcom/tencent/mm/memory/e;->hET:J
    ...
    iget-wide v6, p0, Lcom/tencent/mm/memory/e;->hET:J
    ...
    .line 127
    iget-object v4, p0, Lcom/tencent/mm/memory/e;->hER:Ljava/util/NavigableMap;

    invoke-interface {v4, v1, v0}, Ljava/util/NavigableMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 128
    invoke-direct {p0, v2, v3}, Lcom/tencent/mm/memory/e;->vT(J)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method protected final declared-synchronized vU(J)V
    .locals 3
